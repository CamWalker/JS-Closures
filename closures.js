...
function findPotentialFriends(existingFriends) {
  return function (user) {
    return !(existingFriends.indexOf(user) >= 0);
  }
}
...
var potentialSecondLevelFriends = secondLevelFriends.filter(function (v) {
  return findPotentialFriends(friends)(v);
});
var allPotentialFriends = allUsers.filter(function(value) {
  return findPotentialFriends(friends)(value);
})
